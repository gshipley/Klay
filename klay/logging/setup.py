...
def setup_logging() -> None:
    ...
    log_filename = (
        shared.cache_dir
        / shared.DATA_DIR_NAME
        / "logs"
        / f"{shared.BINARY_NAME}.log"
    )
    ...
    config = {
        ...
        "formatters": {
            ...
            "console_formatter": {
                ...
                "class": "klay.logging.color_log_formatter.ColorLogFormatter",
            },
        },
        "handlers": {
            "file_handler": {
                "class": "klay.logging.session_file_handler.SessionFileHandler",

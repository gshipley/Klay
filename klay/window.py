...
from klay.game_cover import GameCover
from klay.utils.relative_date import relative_date
from gi.repository import Adw, Gio, GLib, Gtk, Pango


@Gtk.Template(resource_path=shared.PREFIX + "/gtk/window.ui")
class KlayWindow(Adw.ApplicationWindow):
    __gtype_name__ = "KlayWindow"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.set_title(shared.APP_NAME)
        self.sidebar_navigation_page.set_title(shared.APP_NAME)
